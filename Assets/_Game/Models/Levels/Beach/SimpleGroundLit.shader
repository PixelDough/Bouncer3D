...
Shader "SimpleGroundLit"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_Albedo("Albedo", Color) = (1,1,1,1)
		[NoScaleOffset]_TripalanrTexture("Tripalanr Texture", 2D) = "white" {}
		[ASEEnd]_TriplanarTiling("Triplanar Tiling", Vector) = (1,1,0,0)
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 triplanar22 = TriplanarSampling22( _TripalanrTexture, WorldPosition, WorldNormal, 1.0, _TriplanarTiling, 1.0, 0 );
				float4 temp_output_23_0 = ( _Albedo * triplanar22 );
				float dotResult12 = dot( IN.ase_normal , float3(0,1,0) );
				float4 lerpResult19 = lerp( ( 0.8 * temp_output_23_0 ) , temp_output_23_0 , ( pow( saturate( dotResult12 ) , 8.0 ) * 1.0 ));
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 triplanar22 = TriplanarSampling22( _TripalanrTexture, WorldPosition, ase_worldNormal, 1.0, _TriplanarTiling, 1.0, 0 );
				float4 temp_output_23_0 = ( _Albedo * triplanar22 );
				float dotResult12 = dot( IN.ase_normal , float3(0,1,0) );
				float4 lerpResult19 = lerp( ( 0.8 * temp_output_23_0 ) , temp_output_23_0 , ( pow( saturate( dotResult12 ) , 8.0 ) * 1.0 ));
...
/*ASEBEGIN
Version=18935
-1920;0;1920;1059;1637;904.5;1;True;False
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;15;-465,-196.5;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;18;-629,-141.5;Inherit;False;Constant;_Float1;Float 1;0;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector3Node;14;-1180,-173.5;Inherit;False;Constant;_Vector0;Vector 0;0;0;Create;True;0;0;0;False;0;False;0,1,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.NormalVertexDataNode;13;-1227,-321.5;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SaturateNode;16;-800,-247.5;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.DotProductOpNode;12;-937,-248.5;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;27;-1863,-399.5;Inherit;False;Property;_TriplanarTiling;Triplanar Tiling;2;0;Create;True;0;0;0;False;0;False;1,1;0.2,0.2;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.PowerNode;17;-645,-247.5;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;8;False;1;FLOAT;0
Node;AmplifyShaderEditor.TriplanarNode;22;-1507,-564.5;Inherit;True;Spherical;World;False;Triplanar Tex;_TriplanarTex;white;0;None;Mid Texture 0;_MidTexture0;white;-1;None;Bot Texture 0;_BotTexture0;white;-1;None;Triplanar Sampler;Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT;1;False;3;FLOAT2;1,1;False;4;FLOAT;1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;20;-556,-683.5;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;23;-927,-604.5;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;21;-744,-797.5;Inherit;False;Constant;_Float2;Float 2;0;0;Create;True;0;0;0;False;0;False;0.8;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;19;-198,-312.5;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;10;-1344,-734.5;Inherit;False;Property;_Albedo;Albedo;0;0;Create;True;0;0;0;False;0;False;1,1,1,1;0.9056604,0.8721464,0.7390531,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TexturePropertyNode;26;-1911,-592.5;Inherit;True;Property;_TripalanrTexture;Tripalanr Texture;1;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;None;c465852aaed51c84b96d64b7b44369dc;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.RangedFloatNode;11;-440,447.5;Inherit;False;Constant;_Float0;Float 0;0;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=4CEB225345A847A935EE9612736C08B1FBDEC853