...
namespace MH.WaterCausticsModules {
    ...
    public class WaterCausticsEffectEditor : Editor {
        ...
        private SerializedProperty m_waterSurfaceAttenWidth;
        private SerializedProperty m_useDepthAtten;
        private SerializedProperty m_depthAttenDepth;
        ...
        private SerializedProperty m_skipSceneView;
        ...
        public void findProps () {
            ...
            m_waterSurfaceAttenWidth = serializedObject.FindProperty ("m_waterSurfaceAttenWidth");
            m_useDepthAtten = serializedObject.FindProperty ("m_useDepthAtten");
            m_depthAttenDepth = serializedObject.FindProperty ("m_depthAttenDepth");
            ...
            m_skipSceneView = serializedObject.FindProperty ("m_skipSceneView");
            ...
            if (!m_clipOutsideVolume.isExpanded) {
                using (var check = new EditorGUI.ChangeCheckScope ()) {
                    ...
                    using (new IndentScope (5, 0)) {
                        ...
                        EditorGUILayout.Space (0.5f);
                        EditorGUILayout.PropertyField (m_skipSceneView, new GUIContent ("Skip Scene View", "No drawing in scene view."));
                    }
                    EditorGUILayout.Space (8);
                ...
                using (new IndentScope ()) {
                    using (var check = new EditorGUI.ChangeCheckScope ()) {
                        ...
                        using (new LabelAndIndentScope ("Near Surface Attenuation", 2f, -2f, 2f)) {
                            EditorGUILayout.PropertyField (m_waterSurfaceAttenWidth, new GUIContent ("Width", "Attenuation width near the water surface."));
                        ...
                        EditorGUILayout.PropertyField (m_useDepthAtten, new GUIContent ("Depth Attenuation", "Use attenuation by depth."));
                        using (new IndentScope (-2f, 2f)) {
                            if (m_useDepthAtten.boolValue)
                                EditorGUILayout.PropertyField (m_depthAttenDepth, new GUIContent ("Depth", "The depth at which the light reaches zero."));
                        }
