...
float Scale = 3, float WaterSurfaceY = 2, float WaterSurfaceAttenWidth = 0.5, float WaterSurfaceAttenOffset = 0, float DepthAttenCoef = 0,
...
// Custom Function (Old)
half3 WCE_WaterCausticsEmission(float3 WorldPos, half3 NormalWS, Texture2D CausticsTex, SamplerState CausticsTexSS,
float Scale = 3, float WaterSurfaceY = 2, float WaterSurfaceAttenWidth = 0.5, float WaterSurfaceAttenOffset = 0,
half IntensityMainLit = 1, half IntensityAddLit = 1, float ColorShiftU = 0.4, float ColorShiftV = -0.1, half LitSaturation = 0.2,
half NormalAttenIntensity = 1, half NormalAttenPower = 2, half TransparentBack = 0) {

    return WCE_WaterCausticsEmission(WorldPos, NormalWS, CausticsTex, CausticsTexSS, Scale, WaterSurfaceY, WaterSurfaceAttenWidth,
    WaterSurfaceAttenOffset, 0, IntensityMainLit, IntensityAddLit, ColorShiftU, ColorShiftV, LitSaturation,
