...
CBUFFER_START(_WCECF_)
    ...
    float _WCECF_WaterSurfaceAttenCoef;
    float _WCECF_WaterSurfaceAttenOffset;
    float _WCECF_DepthAttenCoef;
...
half3 WCE_emissionSyncCore(float3 WorldPos, half3 NormalWS, half3 BaseColor, half intensity = 1) {
    ...
    _WCECF_WaterSurfaceAttenCoef,_WCECF_DepthAttenCoef, _WCECF_IntensityMainLit * intensity, _WCECF_IntensityAddLit * intensity,
